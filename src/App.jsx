...
const OUTER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(3,12,28,0.98)_0%,rgba(5,36,67,0.96)_34%,rgba(6,89,106,0.94)_68%,rgba(10,156,145,0.30)_100%)]";
...
const navItems = [
  { label: "De Nobis", href: "#about" },
  { label: "Proprietates", href: "#features" },
  { label: "Opera Nostra", href: "#portfolio" },
  { label: "Socii", href: "#partners" },
  { label: "Nobis Contactum", href: "#contact" },
];

const stats = [
  { value: "+100", label: "Linguae mundi destinatae" },
  { value: "24/7", label: "Accessus mundialis continuus" },
  { value: "114", label: "Surae completae" },
  { value: "HQ", label: "Sonus et visio altae qualitatis" },
];

const heroCards = [
  { value: "114", label: "Surae" },
  { value: "30", label: "Partes Qurani" },
  { value: "Expolitum", label: "Contentum audiovisuale" },
];

const heroBadges = [
  { icon: Sparkles, title: "Lux et Pulchritudo Qurani" },
  { icon: Globe, title: "Nuntius ad Mundum" },
];
...
const identityCards = [
  {
    icon: Users,
    title: "Qui Sumus",
    text: "Sana est inceptum waqf dicatum significationibus Sacri Qurani mundo divulgandis per canales sonoros et visivos, qui pulchram recitationem cum fideli translatione coniungunt, praebens plenam experientiam spiritualem quae verba Allah cordibus propius admovet in multis linguis mundi.",
  },
  {
    icon: Eye,
    title: "Visio",
    text: "Fieri praecipuum suggestum globale in tradendis significationibus Sacri Qurani unicuique homini sua lingua, per rationem modernam quae pulchritudinem, excellentiam et technologiam provectam coniungit.",
  },
  {
    icon: Target,
    title: "Missio",
    text: "Praebere contentum Quranicum sonorum et visivum translatum, quod significationes Sacri Qurani claras et faciles reddit, ad directionem conferens atque mundum verbis Allah modo allicienti et efficaci introducens.",
  },
];
...
const features = [
  {
    icon: Languages,
    title: "Translationes Multilingues",
    desc: "Significationes Sacri Qurani hominibus suis linguis tradere per stilum clarum et accuratum, qui nuntium intentum servat.",
  },
  {
    icon: Headphones,
    title: "Experientia Audiovisualis Integrata",
    desc: "Canales qui recitationem moventem cum textu translato coniungunt in tranquilla experientia digna maiestate Qurani.",
  },
  {
    icon: Globe,
    title: "Perventio Globalis Continua",
    desc: "Praesentia digitalis et satellitalis quae accessum per continentes et suggesta omni tempore aperit.",
  },
  {
    icon: HeartHandshake,
    title: "Waqf pro Allah",
    desc: "Missio dawah globalis, in qua omnis qui sustinet, confert, vel ex ea beneficium accipit, in mercede partem habet.",
  },
];
...
const channels = [
  {
    icon: Radio,
    title: "Canales Satellitales et Radiophonici",
    desc: "Diffundere significationes Sacri Qurani per canales sonoros et visivos, qui homines per nationes suis linguis attingunt.",
  },
  {
    icon: MonitorPlay,
    title: "Suggesta Socialia et Situs Interretiales",
    desc: "Praesentia digitalis dynamica quae contentum Quranicum facile aditu et late communicatu reddit.",
  },
  {
    icon: Layers3,
    title: "Applicationes et Varia Media Digitalia",
    desc: "Experientia moderna et flexibilis quae usoribus permittit contentum Quranicum sequi modis aptis diversis machinis et suggestis.",
  },
];
...
const partners = [
  {
    icon: ShieldCheck,
    title: "Auctoritates Shariae et Institutiones Islamicae",
    desc: "Qui translationes probatas significationum Qurani contulerunt, accurationem et solidum fundamentum scholasticum confirmantes.",
  },
  {
    icon: Mic2,
    title: "Recitatores Praeclari Vocibus Pulchris",
    desc: "Qui projectum recitationibus humilibus et moventibus ditaverunt, quae corda modo amabili et allicienti attingunt.",
  },
  {
    icon: Headphones,
    title: "Societates Productionis Sonorae et Technicae",
    desc: "Qui recordationes altae qualitatis et tractationem audiovisualem professionalem praebuerunt.",
  },
  {
    icon: Users,
    title: "Productores et Voluntarii",
    desc: "Qui ad contentum evolvendum et publicandum contulerunt, ut quam latissime audientiam per mundum attingere possit.",
  },
];
...
const impactCards = [
  {
    icon: Globe,
    title: "Perventio Globalis",
    desc: "Nuntius Sacri Qurani domos in variis terris mundi attigit per multas linguas quae homines lingua materna alloquuntur.",
  },
  {
    icon: Languages,
    title: "Translationes Fideles",
    desc: "Translationes accuratae significationum Quranicarum sub cura institutorum scholasticorum fiduciae praebitae sunt, ut rectitudo servetur.",
  },
  {
    icon: Headphones,
    title: "Experientia Integrata",
    desc: "Contentum quod recitationem humilem cum translatione visiva coniungit, ut experientiam spiritualem moventem et facile intellectu creet.",
  },
  {
    icon: Send,
    title: "Nuntius Perpetuus",
    desc: "Projectum ad directionem divulgandam et mundum verbis Allah introducendum confert per stilum modernum qui varias audientias attingit.",
  },
];
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className="mt-5 rounded-[1.35rem] border border-white/10 bg-[rgba(5,7,18,0.55)] p-3 sm:p-4">
      <audio
        ref={audioRef}
        preload="metadata"
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-l from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-[#D6B25E]/10">
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-[rgba(5,7,18,0.55)] px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 bg-[rgba(5,7,18,0.55)] px-4 py-4 text-white/80 ${
            large
...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_18%,rgba(14,165,233,0.22),transparent_28%),radial-gradient(circle_at_82%_14%,rgba(55,198,163,0.24),transparent_26%),radial-gradient(circle_at_18%_82%,rgba(8,126,164,0.40),transparent_32%),radial-gradient(circle_at_78%_78%,rgba(8,91,106,0.44),transparent_34%),linear-gradient(135deg,#030C1C_0%,#052443_34%,#06596A_68%,#031525_100%)]" />

        {!isMobile && (
          <>
            <motion.div
              className="absolute -top-28 left-1/2 h-[34rem] w-[34rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(14,165,233,0.22)_0%,rgba(55,198,163,0.14)_42%,transparent_70%)] blur-3xl"
              animate={pulseGlow}
            />
            <motion.div
              className="absolute top-1/3 -left-32 h-[30rem] w-[30rem] rounded-full bg-[radial-gradient(circle,rgba(8,126,164,0.28)_0%,rgba(8,91,106,0.16)_50%,transparent_72%)] blur-3xl"
              animate={pulseGlow}
            />
            <motion.div
              className="absolute bottom-0 -right-28 h-[32rem] w-[32rem] rounded-full bg-[radial-gradient(circle,rgba(8,91,106,0.34)_0%,rgba(14,165,233,0.12)_45%,transparent_72%)] blur-3xl"
              animate={pulseGlow}
            />
            <div className="absolute inset-0 opacity-[0.07]">
              <div className="h-full w-full bg-[linear-gradient(rgba(14,165,233,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(55,198,163,0.08)_1px,transparent_1px)] bg-[size:46px_46px]" />
            </div>
        ...
        <div className={containerClass}>
          ...
          <section className="py-8 lg:py-12">
            ...
            >
              {!isMobile && (
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(14,165,233,0.08),transparent_28%),radial-gradient(circle_at_80%_80%,rgba(55,198,163,0.07),transparent_32%)]" />
              )}
              ...
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                >
                  <div className="flex h-full min-h-[420px] flex-col items-center justify-center">
                    ...
                    <p className="mx-auto mt-4 max-w-xl rounded-[1.4rem] border border-[#D6B25E]/20 bg-[linear-gradient(135deg,rgba(3,12,28,0.74)_0%,rgba(5,36,67,0.68)_100%)] px-4 py-4 text-sm leading-7 text-white/90 sm:px-5 sm:text-base sm:leading-8">
                ...
                <div className={`rounded-[1.8rem] border border-[#D6B25E]/15 p-4 text-center sm:p-5 flex h-full flex-col items-center justify-center ${INNER_GRADIENT}`}>
                  ...
                  <div className="w-full space-y-4 text-white/72 flex flex-col items-center">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex w-full items-center justify-center gap-3 break-all rounded-2xl border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(3,12,28,0.82)_0%,rgba(5,36,67,0.74)_55%,rgba(8,91,106,0.30)_100%)] px-4 py-3 text-sm text-center transition hover:border-[#D6B25E]/30 hover:bg-white/10 sm:text-base"
                    >
                      <Mail
                        className="h-5 w-5 shrink-0"
                        style={{ color: ACCENT }}
                    ...
                    <div className="flex w-full items-center justify-center gap-3 rounded-2xl border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(3,12,28,0.82)_0%,rgba(5,36,67,0.74)_55%,rgba(8,91,106,0.30)_100%)] px-4 py-3 text-sm text-center sm:text-base">
                      <MapPin
                        className="h-5 w-5 shrink-0"
                        style={{ color: ACCENT }}
                      />
                  ...
                  <div className="mt-5 w-full rounded-[1.4rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(3,12,28,0.84)_0%,rgba(5,36,67,0.72)_52%,rgba(8,91,106,0.32)_100%)] p-4 text-center">
                    <a
                ...
                <div className={`rounded-[1.8rem] border border-[#D6B25E]/15 p-4 backdrop-blur-md sm:p-5 text-center flex h-full flex-col items-center justify-center ${INNER_GRADIENT}`}>
                  ...
                  <div className="w-full rounded-[1.4rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(3,12,28,0.84)_0%,rgba(5,36,67,0.72)_52%,rgba(8,91,106,0.32)_100%)] p-4 text-center">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group rounded-[1.3rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(3,12,28,0.62)_0%,rgba(5,36,67,0.62)_60%,rgba(8,91,106,0.24)_100%)] p-4 transition hover:-translate-y-0.5 hover:border-[#D6B25E]/30 hover:bg-white/10"
                      >
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(3,12,28,0.88)_0%,rgba(5,36,67,0.76)_52%,rgba(8,91,106,0.34)_100%)] p-4 text-center">
