...
const OUTER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(5,7,18,0.98)_0%,rgba(16,13,37,0.96)_34%,rgba(8,73,63,0.92)_68%,rgba(214,178,94,0.22)_100%)]";
...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_18%,rgba(214,178,94,0.22),transparent_28%),radial-gradient(circle_at_82%_14%,rgba(55,198,163,0.22),transparent_26%),radial-gradient(circle_at_78%_78%,rgba(8,73,63,0.42),transparent_34%),linear-gradient(135deg,#050712_0%,#100d25_34%,#08493F_68%,#070816_100%)]" />
              ...
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                >
                  <div className="flex h-full min-h-[420px] flex-col items-center justify-center">
                    ...
                    <p className="mx-auto mt-4 max-w-xl rounded-[1.4rem] border border-[#D6B25E]/20 bg-[linear-gradient(135deg,rgba(5,7,18,0.74)_0%,rgba(16,13,37,0.68)_100%)] px-4 py-4 text-sm leading-7 text-white/90 sm:px-5 sm:text-base sm:leading-8">
                ...
                <div className={`rounded-[1.8rem] border border-[#D6B25E]/15 p-4 text-center sm:p-5 flex h-full flex-col items-center justify-center ${INNER_GRADIENT}`}>
                  ...
                  <div className="w-full space-y-4 text-white/72 flex flex-col items-center">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex w-full items-center justify-center gap-3 break-all rounded-2xl border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(5,7,18,0.82)_0%,rgba(16,13,37,0.74)_55%,rgba(8,73,63,0.28)_100%)] px-4 py-3 text-sm text-center transition hover:border-[#D6B25E]/30 hover:bg-white/10 sm:text-base"
                    >
                      <Mail
                        className="h-5 w-5 shrink-0"
                        style={{ color: ACCENT }}
                    ...
                    <div className="flex w-full items-center justify-center gap-3 rounded-2xl border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(5,7,18,0.82)_0%,rgba(16,13,37,0.74)_55%,rgba(8,73,63,0.28)_100%)] px-4 py-3 text-sm text-center sm:text-base">
                      <MapPin
                        className="h-5 w-5 shrink-0"
                        style={{ color: ACCENT }}
                      />
                  ...
                  <div className="mt-5 w-full rounded-[1.4rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(5,7,18,0.84)_0%,rgba(16,13,37,0.72)_52%,rgba(8,73,63,0.30)_100%)] p-4 text-center">
                    <a
                ...
                <div className={`rounded-[1.8rem] border border-[#D6B25E]/15 p-4 backdrop-blur-md sm:p-5 text-center flex h-full flex-col items-center justify-center ${INNER_GRADIENT}`}>
                  ...
                  <div className="w-full rounded-[1.4rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(5,7,18,0.84)_0%,rgba(16,13,37,0.72)_52%,rgba(8,73,63,0.30)_100%)] p-4 text-center">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group rounded-[1.3rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(5,7,18,0.62)_0%,rgba(16,13,37,0.62)_60%,rgba(8,73,63,0.22)_100%)] p-4 transition hover:-translate-y-0.5 hover:border-[#D6B25E]/30 hover:bg-white/10"
                      >
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-[#D6B25E]/15 bg-[linear-gradient(135deg,rgba(5,7,18,0.88)_0%,rgba(16,13,37,0.76)_52%,rgba(8,73,63,0.32)_100%)] p-4 text-center">
